...
def get_memory_service():
    ...
    memory_bank_id = (
        ...
        or os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_MEMORY_BANK_ID")
        or "4417655201473757184"
    )
    if memory_bank_id:
        from google.adk.memory import VertexAiMemoryBankService

        return VertexAiMemoryBankService(
            project=os.environ.get("GOOGLE_CLOUD_PROJECT", "qwiklabs-gcp-04-7459370ad109"),
